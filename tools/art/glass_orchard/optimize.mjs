...
const names = ['glass-orchard','seed-garden','route-repair-depot'];
const report=[];
const pad4 = b => Buffer.concat([b,Buffer.alloc((4-b.length%4)%4)]);
for(const name of names) {
  const source='assets/glass-orchard/exports/'+name+'.glb';
...
await writeFile('assets/glass-orchard/optimization.json',JSON.stringify(report,null,2));
