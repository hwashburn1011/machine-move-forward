...
const names = ['last-garden-meridian','meridian-horizon'];
const report=[];
const pad4 = b => Buffer.concat([b,Buffer.alloc((4-b.length%4)%4)]);
for(const name of names) {
  const source='assets/meridian/exports/'+name+'.glb';
...
await writeFile('assets/meridian/optimization.json',JSON.stringify(report,null,2));
