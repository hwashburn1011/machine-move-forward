...
const names = ['home-furnishings'];
const report=[];
const pad4 = b => Buffer.concat([b,Buffer.alloc((4-b.length%4)%4)]);
for(const name of names) {
  const source='assets/home-life/exports/'+name+'.glb';
...
await writeFile('assets/home-life/optimization.json',JSON.stringify(report,null,2));
