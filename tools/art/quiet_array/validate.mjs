...
const report=[];
for(const name of ['quiet-array','route-water-cache','route-salvage-wreck','route-memorial']){
...
await writeFile('assets/quiet-array/gltf-validation.json',JSON.stringify(report,null,2));
