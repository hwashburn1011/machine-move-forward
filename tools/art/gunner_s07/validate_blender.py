...
ROOT=Path(__file__).resolve().parents[3];OUT=ROOT/'assets/gunner-s07';report=[]
for file in ['S07_Character_Rigged.glb','S07_Character_Rigged.fbx','S07_Heavy_Weapon.glb','S07_Heavy_Weapon.fbx']:
    ...
    if 'Character' in file:
        assert entry['bones']==50,entry
        assert 1.9<bounds[2][1]-bounds[2][0]<2.5,entry
