...
const names = ['fieldwork-kit'];
const report=[];
const pad4 = b => Buffer.concat([b,Buffer.alloc((4-b.length%4)%4)]);
for(const name of names) {
  const source='assets/fieldwork/exports/'+name+'.glb';
...
await writeFile('assets/fieldwork/optimization.json',JSON.stringify(report,null,2));
