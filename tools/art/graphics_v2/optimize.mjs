/**
 * Optimize complete graphics-v2 GLBs without changing their authored graph.
 *
...
const INPUT = path.join(ROOT, 'assets', 'graphics-v2', 'staging');
const OUTPUT = path.join(ROOT, 'assets', 'graphics-v2', 'optimized');
